        ...
        <footer>
          <div className="grid grid-cols-2 gap-12 lg:grid-cols-6 mb-16">
            <div className="col-span-2 mb-8 lg:mb-0">
              <Link href={logo.url} className="flex items-center gap-3 group mb-6">
                <div className="flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/20 group-hover:scale-110 transition-transform duration-300">
                  <Image src="/logo.png" alt="East & Tailor Logo" width={24} height={24} className="text-primary" />
                </div>
                <span className="text-xl font-semibold font-serif">East & Tailor</span>
              </Link>
              <p className="text-muted-foreground leading-relaxed mb-6 max-w-sm">{tagline}</p>
              <div className="flex items-center gap-4">
                <a
                  href="https://instagram.com/eastandtailor"
                  target="_blank"
                ...
                <a
                  href="https://facebook.com/eastandtailor"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex size-9 items-center justify-center rounded-lg bg-muted/50 hover:bg-primary/10 border border-primary/10 hover:border-primary/20 transition-all duration-300"
                  aria-label="Facebook"
                ...
                <a
                  href="https://twitter.com/eastandtailor"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex size-9 items-center justify-center rounded-lg bg-muted/50 hover:bg-primary/10 border border-primary/10 hover:border-primary/20 transition-all duration-300"
                  aria-label="Twitter"
            ...
            {menuItems.map((section, sectionIdx) => (
              <div key={sectionIdx}>
                <h3 className="mb-6 text-sm font-semibold tracking-wide uppercase text-foreground/80 font-serif">
                  {section.title}
                </h3>
          ...
          <div className="mb-16 p-8 rounded-2xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20">
            <div className="max-w-2xl">
              <h3 className="text-xl font-semibold mb-2 font-serif">Join Our Heritage Circle</h3>
