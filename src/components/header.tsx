          ...
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            <div className="flex w-full items-center justify-between gap-12 lg:w-auto">
              ...
              <button
                ...
                className="relative z-20 -m-2.5 -mr-4 block cursor-pointer p-2.5 lg:hidden text-[var(--color-ivory)]"
              >
                ...
                <ul className="flex gap-8 text-sm font-medium">
                  {menuItems.map((item, index) => (
                    <li key={index}>
                      <Link
                        href={item.href}
                        className="text-[var(--color-ivory)]/80 hover:text-[var(--color-gold)] block duration-150"
                      >
                        <span>{item.name}</span>
                      </Link>
                    </li>
            ...
            <div className="bg-[var(--color-navy)] in-data-[state=active]:block lg:in-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-[var(--color-gold)]/20 p-6 shadow-2xl md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none">
                ...
                <ul className="space-y-6 text-base">
                  {menuItems.map((item, index) => (
                    <li key={index}>
                      <Link
                        href={item.href}
                        className="text-[var(--color-ivory)]/80 hover:text-[var(--color-gold)] block duration-150 font-medium"
                      >
                        <span>{item.name}</span>
                      </Link>
                    </li>
